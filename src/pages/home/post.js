...
export default function MainPost (){
    ...
    return(
        ...
        <div className="post">
            <div className="info">
                <div className="user">
                    <div className="imgPost"><img className="profile-pic" src="images/avatar.jpg" alt=""/></div>
                    <p className="username">modern_wed</p>
                </div>
                <svg aria-label="Tùy chọn khác" className="option" color="rgb(245, 245, 245)" fill="rgb(245, 245, 245)" height="24" role="img" viewBox="0 0 24 24" width="24"><circle cx="12" cy="12" r="1.5"></circle><circle cx="6" cy="12" r="1.5"></circle><circle cx="18" cy="12" r="1.5"></circle></svg>
            </div>
            <img src="images/avatar.jpg" className="post-img" alt=""/>
            <div className="icon">
            ...
            <div className="post-content">
                ...
                <p className="description"><span>username</span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis vel dolor qui dolores sint, ducimus sunt atque reprehenderit architecto deserunt, suscipit reiciendis hic commodi maiores animi. Nostrum non sapiente tenetur!</p>
                <p className="post-time">6 minutes ago</p>
            </div>
        ...
        <DetailPost showDetailPost={showDetailPost} setShowDetailPost={setShowDetailPost} />
        </>
    )
